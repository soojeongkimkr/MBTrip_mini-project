                                                ...
                                                <div class="media-content">
                                                    ...
                                                    <nav class="level is-mobile">
                                                            <div class="feeling_div">
                                                                    <button class="button is-white" onclick="intp_like_review('${review}')" ><i class="fa-solid fa-heart"> ${like}</i> </button>
                                                                    <button class="button is-white" onclick="intp_delete_review('${id['_id']}')"><i class="fa-solid fa-trash-can"></i></button>
                                                            </div>
                                                        </nav>
                                                </div>
                                            </article>
...
// 리뷰 삭제하기
function intp_delete_review(id) {
    $.ajax({
        type: 'POST',
        url: '/delete/intp',
        data: {
...
// 좋아요 수
function intp_like_review(review) {
    $.ajax({
        type: 'POST',
        url: '/like/intp',
        data: {
